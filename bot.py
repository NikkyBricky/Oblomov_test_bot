    ...
    if user_data[user_id]['result']:
        ...
        if len(result) == 1:
            ...
            if 'oblomov' in result:
                ...
                bot.send_photo(message.chat.id, pic, 'Вы - Илья Ильич Обломов на '
                                                     f'{percent}%.\n\n'
            ...
            if 'shtolz' in result:
                ...
                bot.send_photo(message.chat.id, pic, 'Вы - Андрей Иванович Штольц на '
                                                     f'{percent}%.\n\n'
            ...
            if 'olga' in result:
                ...
                bot.send_photo(message.chat.id, pic,  'Вы - Ольга Сергеевна Ильинская на '
                                                      f'{percent}%.\n\n'
            ...
            if 'zakhar' in result:
                ...
                bot.send_photo(message.chat.id, pic, 'Вы - Захар на '
                                                     f'{percent}%.\n\n'
